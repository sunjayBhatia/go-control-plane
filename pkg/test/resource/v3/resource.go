...
import (
	...
	alf "github.com/envoyproxy/go-control-plane/api/envoy/config/accesslog/v3"
	...
	endpoint "github.com/envoyproxy/go-control-plane/api/envoy/config/endpoint/v3"
	listener "github.com/envoyproxy/go-control-plane/api/envoy/config/listener/v3"
	route "github.com/envoyproxy/go-control-plane/api/envoy/config/route/v3"
	als "github.com/envoyproxy/go-control-plane/api/envoy/extensions/access_loggers/grpc/v3"
	router "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/http/router/v3"
	hcm "github.com/envoyproxy/go-control-plane/api/envoy/extensions/filters/network/http_connection_manager/v3"
